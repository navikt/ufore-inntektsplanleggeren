...
export const InputSummary = (props: { inntekter: PersonInntekter }) => {
    ...
    return (
        <VStack gap="1">
            <BodyShort>Arbeidsinntekt og pensjonsgivende ytelser: <FormatKroner value={props.inntekter.arbeidsinntekt ?? 0}/></BodyShort>         {/*    TODO not show irrelevant fields or show 0? bold text? */}
