...
export const ExpectedIncomeBox: React.FC<ExpectedIncomeBoxProps> = ({
  forventetInntekt,
  ...
  return (
    <Box borderRadius="xlarge" padding="4" className="top-box">
      <VStack gap="7">
        ...
        {isOpen && (
          <BodyLong>
            Forventet inntekt kan komme fra dine tidligere registreringer, eller i noen tilfeller fra opplysninger vi
            har hentet. Har du nylig meldt inn inntekt, vil den ikke vises her før den har blitt behandlet hos oss.
          </BodyLong>
        )}
