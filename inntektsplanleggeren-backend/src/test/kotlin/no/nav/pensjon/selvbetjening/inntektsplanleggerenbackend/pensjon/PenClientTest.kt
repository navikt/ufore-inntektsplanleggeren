...
class PenClientTest : WebClientTest() {
    ...
    fun `should return Pensjonsdata when 200 from fetchInntektsplanleggerData`() {
        ...
        assertNull(pensjonsdata.grenseStoppAvBarnetilleggSaerkullsbarn)
        assertNull(pensjonsdata.fribelopBarnetilleggSaerkullsbarn)
        assertTrue(pensjonsdata.barnetilleggFellesbarn)
        assertEquals(669751, pensjonsdata.grenseStoppAvBarnetilleggFellesbarn)
        assertEquals(570529, pensjonsdata.fribelopBarnetilleggFellesbarn)
