        ...
        <VStack className="vstack-gap">
          ...
          <div className="description-card">
            <ReadMore header="Inntekt du skal legge inn">
              Legg inn lønn fra arbeidsgiver som et årsbeløp. Ta med eventuell bonus, ekstratimer, overtidsbetaling og
              feriepenger for det gjeldende året. Inntekter som er pensjonsgivende skal meldes inn. Vanlige
              pensjonsgivende ytelser er sykepenger, arbeidsavklaringspenger (AAP), dagpenger, foreldrepenger,
              svangerskapspenger, omstillingsstønad, overgangsstønad, omsorgs-, pleie- eller opplæringspenger fra oss.
      ...
      {forventedeInntekter.naeringsinntekt !== null && (
        <VStack className="vstack-gap">
          ...
          <ReadMore header="Næringsinntekt du skal legge inn">
            Legg inn det du forventer å tjene fra næringsvirksomhet i Norge som et årsbeløp før skatt. Er du usikker på
            hva som regnes som pensjonsgivende næringsinntekt kan du kontakte Skatteetaten.
          </ReadMore>
        </VStack>
      )}
      ...
      {forventedeInntekter.pensjonUtland !== null && (
        <VStack className="vstack-gap">
          ...
          <ReadMore header="Pensjoner du skal legge inn">
            Legg inn pensjoner fra utlandet som et årsbeløp før skatt. Inntekten du oppgir her har bare betydning for
            størrelsen på barnetillegget ditt.
          </ReadMore>
        </VStack>
      )}
