...
interface Props {
    ...
    isLoading: boolean
    regelverksendringer2026: boolean
}

export function YearView({ availableYears, anotherAvalableYear, handleSubmit, isLoading, regelverksendringer2026 }: Props) {
                        ...
                        {!regelverksendringer2026 && (
                            <ReadMore header="Tidspunkt for å registrere inntekt">
                                <List>
                                    ...
                                    <List.Item>
                                        Fra 1. til 31. desember kan du bare registrere inntekt for neste år, fordi endringen ikke vil påvirke utbetalingen din
                                        før til neste år.
                                    </List.Item>
                                </List>
                            </ReadMore>
