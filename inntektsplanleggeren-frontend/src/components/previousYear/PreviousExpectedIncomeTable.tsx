...
export const PreviousExpectedIncomeTable = (props: {
  personInntekter: PersonInntekter
  year: number
  eps: boolean
}) => {
  const { arbeidsinntekt, andrePensjonsgivendeYtelser, naeringsinntekt, inntektUtland, pensjonUtland } =
    props.personInntekter
        ...
        <Table.Row>
          <Table.DataCell>
            <VStack gap="1">
              ...
              <BodyShort>
                Beløp før skatt: <FormatKroner value={arbeidsinntekt || 0} />
              </BodyShort>
            </VStack>
          </Table.DataCell>
        </Table.Row>
        <Table.Row>
          <Table.DataCell>
            <VStack gap="1">
              ...
              <BodyShort>
                Beløp før skatt: <FormatKroner value={naeringsinntekt || 0} />
              </BodyShort>
            </VStack>
          </Table.DataCell>
        </Table.Row>
        <Table.Row>
          <Table.DataCell>
            <VStack gap="1">
              ...
              <BodyShort>
                Beløp før skatt: <FormatKroner value={inntektUtland || 0} />
              </BodyShort>
            </VStack>
          </Table.DataCell>
        </Table.Row>
        <Table.Row>
          <Table.DataCell>
            <VStack gap="1">
              ...
              <BodyShort>
                Beløp før skatt: <FormatKroner value={andrePensjonsgivendeYtelser || 0} />
              </BodyShort>
            </VStack>
          </Table.DataCell>
        </Table.Row>
        <Table.Row>
          <Table.DataCell>
            <VStack gap="1">
              ...
              <BodyShort>
                Beløp før skatt: <FormatKroner value={pensjonUtland || 0} />
              </BodyShort>
            </VStack>
          </Table.DataCell>
        </Table.Row>
