...
import no.nav.ufore.inntektsplanleggeren.inntekt.model.Personinntekt
    ...
    fun setup() {
        ...
        `when`(inntektService.getForventedeInntekter(any(), any(), anyInt())).thenReturn(
            ForventedeInntekterSummary(
                no.nav.ufore.inntektsplanleggeren.inntekt.model.ForventedeInntekter(
                    no.nav.ufore.inntektsplanleggeren.inntekt.model.PersonInntekter(
