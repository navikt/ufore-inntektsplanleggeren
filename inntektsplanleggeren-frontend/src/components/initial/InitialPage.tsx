...
export function InitialPage() {
  const { initiateResponse, setInntekterResponse, setPreviousYearInntekterResponse, errorMessage, setErrorMessage } =
  ...
  if (initiateResponse.messages.some((message) => message.messageCode === MessageCodes.USER_HAS_NO_UFORE)) {
    ...
    return (
      <Alert variant="warning">
        Du kan ikke bruke inntektsplanleggeren ennå. Din inntekt kan registreres her fra måneden før din første
  ...
  return (
    <VStack className="form-container">
      <GuidePanel poster>
        ...
        <BodyShort spacing>
          For at vi skal beregne riktig utbetaling av uføretrygden din, må du oppgi hvor mye du forventer å tjene
          samtidig som du får uføretrygd.
        </BodyShort>
        <BodyShort>
          Dine opplysninger lagres dessverre ikke hvis du logger ut av innteksplanleggeren, eller tar en lang pause. Vi
          beklager for dette.
        </BodyShort>
      </GuidePanel>
      ...
      <section>
        <BodyLong>
          Det er viktig at du melder fra hvis inntekten din blir annerledes enn det du har meldt inn tidligere. Det gir
          mindre risiko for stor tilbakebetaling i etteroppgjøret.
        </BodyLong>
      </section>
      ...
      <Accordion>
        <Accordion.Item>
          ...
          <Accordion.Content>
            <List>
              <List.Item>
                Du oppgir hva du forventer å tjene, så beregner vi riktig utbetaling av uføretrygden din. Hvis du har
                barnetillegg og bor sammen med barnets andre forelder, skal du også oppgi forelderens inntekt.
              </List.Item>
              <List.Item>
              ...
              <List.Item>Husk å undersøke om du skal legge til feriepenger og andre utbetalinger.</List.Item>
              <List.Item>Du kan melde fra om forventet inntekt for neste år fra oktober i år.</List.Item>
              <List.Item>
                Har du ingen endring i inntekten din til neste år, bør du likevel melde inn forventet inntekt.
              </List.Item>
              <List.Item>
                Melder du ikke fra om forventet inntekt til neste år, vil vi bruke inntekten du har oppgitt i år og
                justere den ved årsskiftet.
              </List.Item>
        ...
        <Accordion.Item>
          ...
          <Accordion.Content>
            <VStack gap="8">
              <BodyShort>
                Har du variabel inntekt, kan det være vanskelig å vite hva du kommer til å tjene fremover. Vi stoler på
                at du melder fra til oss så godt du kan.
              </BodyShort>
              <BodyShort>
                Ser du at inntekten din blir annerledes enn det du tidligere har meldt inn, bør du melde fra til oss så
                fort som mulig.
              </BodyShort>
            </VStack>
          </Accordion.Content>
        ...
        <Accordion.Item>
          ...
          <Accordion.Content>
            Inntektsplanleggeren viser bare hvordan inntekt påvirker uføretrygden. Innsending via inntektsplanleggeren
            påvirker kun din uføretrygd, og eventuelt barnetillegg og gjenlevendetillegg hvis du har det. Har du andre
            pengestøtter fra Nav, må du si i fra om ny inntekt til disse. Endring i din inntekt kan påvirke pengestøtter
            fra andre enn Nav, og kan det være at du må melde fra om endring i inntekt til disse også.
          </Accordion.Content>
        </Accordion.Item>
      </Accordion>
