...
export const PreviousYearPage = () => {
    ...
    return (
        <VStack className="page">
            ...
            <Heading level="2" size="medium">Registrert forventet inntekt for {previousYear}</Heading>
            <VStack gap={"10"}>
                {(previousYearInntekterResponse.forventedeInntekter.bruker !== null && previousYear !== null) &&
                    <PreviousExpectedIncomeTable personInntekter={previousYearInntekterResponse.forventedeInntekter.bruker} eps={false} year={previousYear}/>}
                {(previousYearInntekterResponse.forventedeInntekter.eps !== null && previousYear !== null) &&
                    <PreviousExpectedIncomeTable personInntekter={previousYearInntekterResponse.forventedeInntekter.eps} eps={true} year={previousYear}/>}
            </VStack>
