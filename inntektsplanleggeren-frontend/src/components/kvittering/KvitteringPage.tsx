    ...
    return (
      <Box background="bg-subtle" padding="16" borderRadius="large">
        <VStack className="form-container" align="center" gap="20">
          <Heading level="2" size="large" align="center">Vent mens vi sender inn</Heading>
          <Loader size="3xlarge" />
  ...
  return (
    <VStack className="form-container">
      ...
      {statusResponse?.status === StatusCodes.TIL_BEHANDLING &&
        <section>
          <Heading level="3" size={"large"}>Hva skjer videre?</Heading>
          <List as="ul">
      ...
      <section>
        <Heading className="header" level="3" size={"large"}>Hvis inntekten din endrer seg</Heading>
        <BodyLong>
      ...
      <section>
        <Heading className="header" level="3" size={"large"}>Husk å oppdatere skattekortet</Heading>
        <BodyLong>
      ...
      <section>
        <Heading className="header" level="3" size={"large"}>Må du melde fra til flere?</Heading>
        <BodyLong>
        ...
        <HStack gap="4">
          <Button as={Link} to={import.meta.env.VITE_DIN_UFORETRYGD_URL} variant="primary" className="button-container">Din uføretrygd</Button>
        </HStack>
      </section>
    </VStack>
  );
