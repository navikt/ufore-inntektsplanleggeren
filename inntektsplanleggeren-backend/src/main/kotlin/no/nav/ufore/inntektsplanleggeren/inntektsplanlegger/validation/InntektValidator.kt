...
import no.nav.ufore.inntektsplanleggeren.inntekt.model.InntekterHittilIAar
...
class InntektValidator(val inntektService: InntektService) {
    ...
    private fun validateInntektStatus(forventedeInntekter: no.nav.ufore.inntektsplanleggeren.inntekt.model.ForventedeInntekter): InntektsplanleggerMessage? {
    ...
    private fun validateEpsInntektChanged(
        inputInntektData: ForventedeInntekter,
        registeredForventedeInntekter: no.nav.ufore.inntektsplanleggeren.inntekt.model.ForventedeInntekter
    ): InntektsplanleggerMessage? {
