import {Alert, BodyLong, BodyShort, Box, FormSummary, Heading, Show, VStack} from '@navikt/ds-react'
...
export const InntektSummaryBruker = (props: { inntekt: PersonInntekter, messages: Message[] | undefined, inntektSum: number}) => {
    ...
    console.log("arbeidsinntektMessage", arbeidsinntektMessage)
          ...
          {props.inntekt.pensjonUtland !== null && (
            ...
            <FormSummary.Answer>
                <Box padding="4" background="surface-subtle" borderRadius="large">
                    <VStack>
                        <Heading size="small">Din samlede forventede inntekt i {selectedYear} : </Heading>
