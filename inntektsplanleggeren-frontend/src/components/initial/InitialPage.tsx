      ...
      <Accordion>
        <Accordion.Item>
          ...
          <Accordion.Content>
            <List>
              <List.Item>
                Du oppgir hva du forventer å tjene, så beregner vi riktig utbetaling av uføretrygden din. Hvis du har barnetillegg og bor sammen med barnets andre forelder, skal du også oppgi forelderens inntekt.
              </List.Item>
              <List.Item>
                Når du melder inn en endring i inntekten din, lager vi en ny beregning. Hvis inntekten du melder inn påvirker uføreutbetalingene dine, vil alle dine månedlige utbetalingene bli justert.
              </List.Item>
              <List.Item>
                Får du for mye utbetalt, må du betale tilbake. Får du for lite utbetalt, betaler Nav penger tilbake til deg. Dette kalles etteroppgjør.
              </List.Item>
              <List.Item>
                Du skal oppgi årlig inntekt før skatt (brutto).
              </List.Item>
              <List.Item>
                Du skal bare oppgi inntekt du har samtidig med uføretrygd.
              </List.Item>
              <List.Item>
                Husk å undersøke om du skal legge til feriepenger og andre utbetalinger.
              </List.Item>
              <List.Item>
                Du kan melde fra om forventet inntekt for neste år fra oktober i år.
              </List.Item>
              <List.Item>
              ...
              <List.Item>
                Vi melder ikke inn din inntekt til Skatteetaten.
              </List.Item>
            </List>
          </Accordion.Content>
        </Accordion.Item>
