        ...
        <VStack gap="2" style={{ marginBottom: '20px' }}>
          ...
          <VStack gap="5">
            <BodyLong style={{ whiteSpace: 'pre-wrap' }}>
              Dine inntektsgrenser sier hvor mye inntekt du kan ha før vi trekker en prosent (kompensasjonsgrad) av
              utbetalingen din.
            </BodyLong>
            ...
            {isOpen ? (
              <VStack gap="5">
                <section>
                  ...
                  {props.displayData.hasVarigTilrettelagtArbeid ? (
                    <BodyLong style={{ wordBreak: 'normal' }}>
                      ...
                      . Bonuslønnen din kan være inntil{' '}
                      <FormatKroner value={props.displayData.inntektsgrense}></FormatKroner> (som tilsvarer 1 G). Tjener
                      du mer enn dette, vil du få lavere utbetaling av uføretrygd. Vi reduserer uføretrygden din av
                      beløpet du tjener over inntektsgrensen. Beløpet opp til inntektsgrensen blir du aldri trukket for. I
                      de fleste tilfeller vil det lønne seg å jobbe, fordi uføretrygd og inntekt er høyere enn uføretrygd
                      alene.
                    </BodyLong>
                  ) : (
                    <BodyLong style={{ wordBreak: 'normal' }}>
                ...
                <section>
                  <Heading size="xsmall" level="3">
                    Din trekkprosent (kompensasjonsgrad):{' '}
                    <FormatDecimalNumber value={props.displayData.kompensasjonsgrad} /> prosent
                  </Heading>
                  <BodyLong style={{ wordBreak: 'normal' }}>
                    Tjener du mer enn inntektsgrensen, får du lavere utbetaling av uføretrygd, ut fra din trekkprosent. Vi
                    trekker <FormatDecimalNumber value={props.displayData.kompensasjonsgrad} /> prosent kun av det du har
                    tjent over inntektsgrensen. Du vil fortsatt få utbetalt redusert uføretrygd i tillegg til lønnen din.
                  </BodyLong>
                </section>

                <section>
                  <Heading size="xsmall" level="3">
                    Tjener du mer enn <FormatKroner value={props.displayData.grenseStoppAvUfoeretrygd} /> får du ikke
                    utbetalt uføretrygd
                  </Heading>
                  <List>
                    <List.Item>
                      Har du inntekt på mer enn <FormatKroner value={props.displayData.grenseStoppAvUfoeretrygd} /> per
                      år, får du ikke utbetaling av uføretrygd det aktuelle året.
                    </List.Item>
                    <List.Item>
                      Tjener du mer enn <FormatKroner value={props.displayData.grenseStoppAvUfoeretrygd} /> et kalenderår,
                      må du betale tilbake det du har fått i uføretrygd det året.
                    </List.Item>
                    <List.Item>
                      Du beholder likevel retten til uføretrygd. Tjener du mindre neste år, kan du igjen få utbetalt
                      uføretrygd.{' '}
                    </List.Item>
                  </List>
                </section>
